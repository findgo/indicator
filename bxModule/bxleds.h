...
#define BXTURN_LED1_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDA1_PORT,BX_HAL_LEDA1_PIN)
#define BXTURN_LED1_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDA1_PORT,BX_HAL_LEDA1_PIN)
#define BXTURN_LED2_ON()	 	LL_GPIO_SetOutputPin(BX_HAL_LEDA2_PORT,BX_HAL_LEDA2_PIN)
#define BXTURN_LED2_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDA2_PORT,BX_HAL_LEDA2_PIN)
#define BXTURN_LED3_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDB1_PORT,BX_HAL_LEDB1_PIN)
#define BXTURN_LED3_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDB1_PORT,BX_HAL_LEDB1_PIN)
#define BXTURN_LED4_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDB2_PORT,BX_HAL_LEDB2_PIN)
#define BXTURN_LED4_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDB2_PORT,BX_HAL_LEDB2_PIN)
#define BXTURN_LED5_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDC1_PORT,BX_HAL_LEDC1_PIN)
#define BXTURN_LED5_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDC1_PORT,BX_HAL_LEDC1_PIN)
#define BXTURN_LED6_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDC2_PORT,BX_HAL_LEDC2_PIN) 
#define BXTURN_LED6_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDC2_PORT,BX_HAL_LEDC2_PIN)
#define BXTURN_LED7_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDD1_PORT,BX_HAL_LEDD1_PIN)
#define BXTURN_LED7_OFF()	    LL_GPIO_ResetOutputPin(BX_HAL_LEDD1_PORT,BX_HAL_LEDD1_PIN)
#define BXTURN_LED8_ON()	    LL_GPIO_SetOutputPin(BX_HAL_LEDD2_PORT,BX_HAL_LEDD2_PIN)
#define BXTURN_LED8_OFF()       LL_GPIO_ResetOutputPin(BX_HAL_LEDD2_PORT,BX_HAL_LEDD2_PIN)
#define BXTURN_LED9_ON()		LL_GPIO_SetOutputPin(BX_HAL_LEDE1_PORT,BX_HAL_LEDE1_PIN)
